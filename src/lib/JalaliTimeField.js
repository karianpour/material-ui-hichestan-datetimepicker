...
/**
 * The `JalaliTimeField` is a convenience wrapper for the most common cases (80%).
 ...
 * };
 *
 * return <JalaliTimeField id="time" type="time" inputProps={inputProps} />;
 * ```
 *
 * For advanced cases, please look at the source of JalaliTimeField by clicking on the
...
JalaliTimeField.defaultProps = {
  required: false,
};

export default JalaliTimeField;